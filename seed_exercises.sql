-- Clear existing exercises to avoid duplicates/conflicts during development re-seeding
...
('Sentadillas (Air Squats)', 'Legs', 'E', 'Strength', 'Both', 
 'img/exercises/squat.jpg', 'https://www.youtube.com/embed/C_VtOYc6j5c', 
...
('Zancadas (Lunges)', 'Legs', 'E', 'Strength', 'Both',
 'img/exercises/lunge.jpg', 'https://www.youtube.com/embed/QOVaHwm-Q6U',
 '1. Da un paso largo hacia adelante.\n2. Baja la rodilla trasera casi al suelo.\n3. Alterna piernas.'),

('Plancha (Plank)', 'Core', 'E', 'Stamina', 'Both',
 'img/exercises/plank.jpg', 'https://www.youtube.com/embed/ASdvN_XEl_c',
...
('Flexiones de Rodillas', 'Chest', 'E', 'Strength', 'Both',
 'img/exercises/knee_pushup.jpg', 'https://www.youtube.com/embed/W_LP8n5q-aY',
 '1. Apoya rodillas en el suelo.\n2. Baja el pecho hasta el suelo.\n3. Empuja para subir.'),

-- Rank D
('Flexiones Estándar', 'Chest', 'D', 'Strength', 'Both',
 'img/exercises/pushup.jpg', 'https://www.youtube.com/embed/IODxDxX7oi4',
 '1. Manos bajo los hombros.\n2. Cuerpo recto.\n3. Baja hasta tocar el suelo con el pecho.'),

('Burpees', 'Full Body', 'D', 'Explosive', 'Both',
 'img/exercises/burpee.jpg', 'https://www.youtube.com/embed/TU8QYXL8gSk',
 '1. Sentadilla.\n2. Plancha.\n3. Flexión.\n4. Salto vertical.'),

('Mountain Climbers', 'Core', 'D', 'Cardio', 'Both',
 'img/exercises/mountain_climber.jpg', 'https://www.youtube.com/embed/nmwgirgXLYM',
...
('Fondos en Banco', 'Arms', 'D', 'Strength', 'Both',
 'img/exercises/dips.jpg', 'https://www.youtube.com/embed/0326dy_-CzM',
...
('Dominadas (Pull-ups)', 'Back', 'C', 'Strength', 'Both',
 'img/exercises/pullup.jpg', 'https://www.youtube.com/embed/eGo4IYlbE5g',
 '1. Cuélgate de la barra.\n2. Sube hasta pasar la barbilla.\n3. Controla la bajada.'),

('Flexiones Diamante', 'Arms', 'C', 'Strength', 'Both',
 'img/exercises/diamond_pushup.jpg', 'https://www.youtube.com/embed/J0DnG1_S92I',
...
('Sentadillas con Salto', 'Legs', 'C', 'Explosive', 'Both',
 'img/exercises/jump_squat.jpg', 'https://www.youtube.com/embed/CVaEhXotL7M',
